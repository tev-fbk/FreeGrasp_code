...
class LangSAM():
    ...
    def predict(self, image_pil, text_prompt, box_threshold=0.25, text_threshold=0.2):
    ...
    def save(self, masks, boxes, phrases, logits,image_pil, path, viz):
        if len(masks) == 0:
            ...
            for i, mask_np in enumerate(masks_np):
                mask_path = f"{path}/image_mask_{i + 1}.png"
